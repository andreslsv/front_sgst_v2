...
@Component({
    selector: 'vex-afiliaciones',
    templateUrl: './afiliaciones.component.html',
    styleUrls: ['./afiliaciones.component.scss']
})
export class AfiliaicionesComponent implements OnInit {
    id = '';
    resultsLength = 0;
    pageSize = 10;
    ...
    openEmpresaModal() {
        ...
        //     data: {
        //         servicio: 'AFILIACIONES PARA SEGURIDAD SOCIAL'
        //     }
        // });
    ...
    loadEmpresaPaginator() {
        ...
        const queryParams = ` ${status}, id_afiliacion: ${this.afiliacionId} search2: "AFILIACIONES PARA SEGURIDAD SOCIAL", limit: ${this.limit}, offset: ${this.offset}, orderby: "${this.orderBy}", order: "${this.order}", ${searchText} ${date} ${date2}`;
        const queryProps =
