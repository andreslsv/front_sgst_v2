...
export class PlanillasComponent implements OnInit {
    ...
    openEmpresaModal() {
        ...
        //     data: {
        //         servicio: 'LIQUIDACION Y PAGOS DE PLANILLAS'
        //     }
        // });
    ...
    loadEmpresaPaginator() {
        ...
        const queryParams = `id_afiliacion: ${this.afiliacionId} ${status}, search2: "LIQUIDACION Y PAGOS DE PLANILLAS", limit: ${this.limit}, offset: ${this.offset}, orderby: "${this.orderBy}", order: "${this.order}", ${searchText} ${date} ${date2}`;
        const queryProps =
