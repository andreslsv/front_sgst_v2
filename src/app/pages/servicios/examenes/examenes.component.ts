...
export class ExamenesComponent implements OnInit {
    ...
    openEmpresaModal() {
        ...
        //     data: {
        //         servicio: 'EXAMENES OCUPACIONALES'
        //     }
        // });
    ...
    loadEmpresaPaginator() {
        ...
        const queryParams = `id_afiliacion: ${this.afiliacionId} ${status} search2: "EXAMENES OCUPACIONALES", limit: ${this.limit}, offset: ${this.offset}, orderby: "${this.orderBy}", order: "${this.order}", ${searchText} ${date} ${date2}`;
        const queryProps =
