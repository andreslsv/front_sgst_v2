...
export class ContratosComponent implements OnInit {
    ...
    loadEmpresaPaginator() {
        ...
        const queryParams = `id_afiliacion: ${this.afiliacionId} ${status}, search2: "CONTRATOS", limit: ${this.limit}, offset: ${this.offset}, orderby: "${this.orderBy}", order: "${this.order}", ${searchText} ${date} ${date2}`;
        const queryProps =
    ...
    //             : '';
    //     const searchText = this.filters.value.search !== '' ? `search: "${this.filters.value.search}",` : '';
    //     const queryParams = `contrato_status: 1 limit: ${this.limit}, offset: ${this.offset}, orderby: "${this.orderBy}", order: "${this.order}", ${searchText} ${date} ${date2}`;
    //     const queryProps =
